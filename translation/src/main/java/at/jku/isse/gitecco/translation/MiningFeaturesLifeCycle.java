...
import at.jku.isse.gitecco.featureid.type.*;
...
public class MiningFeaturesLifeCycle {
    ...
    //RQ1
    public static void characteristicsChange2(GitHelper gitHelper, File changeFolder, GitCommit gc, ArrayList<String> featureNamesList) throws Exception {
